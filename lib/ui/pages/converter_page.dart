...
class _ConverterPageState extends State<ConverterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('Conversor Monedas'),
        ),
        body: Column(children: [
          Row(
           ...
           Expanded(
              ...
              child: Center(
              child: KeyPad(textCurrency1: currencies[currency1], textCurrency2: currencies[currency2] , rate: rates[currencies.indexWhere((item) => item == currencies[currency1])][currencies.indexWhere((item) => item == currencies[currency2])]),
          ))
        ]));
  }
}
